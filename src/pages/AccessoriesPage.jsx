...
const cataloguesUrl = import.meta.env.VITE_URL_ACCESSORI;
        ...
        <>
            <main>
                ...
                {loading ? (
                    ...
                    <>
                        <BestSeller BestSeller={catalogue.accessori_preferiti} Accessorio="true"/>
                        ...
                        <ProductsList articoli={catalogue.accessori_collegati} tipo={"accessorio"} />
                    </>
                )}
            </main>
        </>
